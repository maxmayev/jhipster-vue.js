...
import ConsumerComponent from '@/entities/consumer/consumer.vue';
import ConsumerClass from '@/entities/consumer/consumer.component';
...
describe('Component Tests', () => {
  describe('Consumer Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ConsumerClass>(ConsumerComponent, {
        store,
        localVue,
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(consumerServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(consumerServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});

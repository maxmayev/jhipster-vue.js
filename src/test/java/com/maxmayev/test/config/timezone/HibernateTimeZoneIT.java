package com.maxmayev.test.config.timezone;

import com.maxmayev.test.JhipsterProjectApp;
import com.maxmayev.test.repository.timezone.DateTimeWrapper;
import com.maxmayev.test.repository.timezone.DateTimeWrapperRepository;

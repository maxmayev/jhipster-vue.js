...
import com.maxmayev.test.domain.Category;
import com.maxmayev.test.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.maxmayev.test.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
